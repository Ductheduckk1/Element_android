...
//        const val SETTINGS_SECURE_BACKUP_RESET_PREFERENCE_KEY = "SETTINGS_SECURE_BACKUP_RESET_PREFERENCE_KEY"
        ...
        const val SETTINGS_IN_APP_NOTIF_KEY = "SETTINGS_IN_APP_NOTIF_KEY"
        const val SETTINGS_SHOW_DECRYPTED_KEY = "SETTINGS_SHOW_DECRYPTED_KEY"
        const val SETTINGS_PIN_MISSED_ROOMS_KEY = "SETTINGS_PIN_MISSED_ROOMS_KEY"
        const val SETTINGS_PIN_UNREAD_ROOMS_KEY = "SETTINGS_PIN_UNREAD_ROOMS_KEY"
    ...
    fun areInAppNotificationsEnabled(): Boolean {
        return sharedPreferences.getBoolean(SETTINGS_IN_APP_NOTIF_KEY, true)
    }

    fun setInAppNotificationEnabled(enabled: Boolean) {
        sharedPreferences.edit().putBoolean(SETTINGS_IN_APP_NOTIF_KEY, enabled).apply()
    }

    fun showDecryptedContentInNotifications(): Boolean {
        return sharedPreferences.getBoolean(SETTINGS_SHOW_DECRYPTED_KEY, false)
    }

    fun setShowDecryptedContentInNotifications(enabled: Boolean) {
        sharedPreferences.edit().putBoolean(SETTINGS_SHOW_DECRYPTED_KEY, enabled).apply()
    }

    fun pinMissedNotificationsRooms(): Boolean {
        return sharedPreferences.getBoolean(SETTINGS_PIN_MISSED_ROOMS_KEY, true)
    }

    fun setPinMissedNotificationsRooms(enabled: Boolean) {
        sharedPreferences.edit().putBoolean(SETTINGS_PIN_MISSED_ROOMS_KEY, enabled).apply()
    }

    fun pinUnreadRooms(): Boolean {
        return sharedPreferences.getBoolean(SETTINGS_PIN_UNREAD_ROOMS_KEY, true)
    }

    fun setPinUnreadRooms(enabled: Boolean) {
        sharedPreferences.edit().putBoolean(SETTINGS_PIN_UNREAD_ROOMS_KEY, enabled).apply()
    }
    fun setSwipeToReply(enabled: Boolean) {
        defaultPrefs.edit {
            putBoolean(SETTINGS_LABS_ENABLE_SWIPE_TO_REPLY, enabled)
        }
    }

    fun setLatexEnabled(enabled: Boolean) {
        defaultPrefs.edit {
            putBoolean(SETTINGS_LABS_ENABLE_LATEX_MATHS, enabled)
        }
    }

    fun setLiveLocationSharingEnabled(enabled: Boolean) {
        defaultPrefs.edit {
            putBoolean(SETTINGS_LABS_ENABLE_LIVE_LOCATION, enabled)
        }
    }

    fun isLaoAppCallShortcutEnabled(): Boolean {
        return labsEnableElementCallPermissionShortcuts()
    }

    fun setLaoAppCallShortcutEnabled(enabled: Boolean) {
        defaultPrefs.edit {
            putBoolean(SETTINGS_LABS_ENABLE_ELEMENT_CALL_PERMISSION_SHORTCUTS, enabled)
        }
    }

    fun setDeferredDmEnabled(enabled: Boolean) {
        defaultPrefs.edit {
            putBoolean(SETTINGS_LABS_DEFERRED_DM_KEY, enabled)
        }
    }

    fun setRichTextEditorEnabled(enabled: Boolean) {
        defaultPrefs.edit {
            putBoolean(SETTINGS_LABS_RICH_TEXT_EDITOR_KEY, enabled)
        }
    }

    fun setNewSessionManagerEnabled(enabled: Boolean) {
        defaultPrefs.edit {
            putBoolean(SETTINGS_LABS_NEW_SESSION_MANAGER_KEY, enabled)
        }
    }
    fun isLatexEnabled(): Boolean {
        return latexMathsIsEnabled()
    }

    fun isLiveLocationEnabled(): Boolean {
        return labsEnableLiveLocation()
    }
    fun isUseRageShakeEnabled(): Boolean {
        return sharedPreferences.getBoolean("SETTINGS_USE_RAGE_SHAKE_KEY", true)
    }

    fun setUseRageShake(enabled: Boolean) {
        sharedPreferences.edit().putBoolean("SETTINGS_USE_RAGE_SHAKE_KEY", enabled).apply()
    }

    fun getRageShakeDetectionThreshold(): Int {
        return sharedPreferences.getInt("SETTINGS_RAGE_SHAKE_DETECTION_THRESHOLD_KEY", 13)
    }

    fun setRageShakeDetectionThreshold(threshold: Int) {
        sharedPreferences.edit().putInt("SETTINGS_RAGE_SHAKE_DETECTION_THRESHOLD_KEY", threshold).apply()
    }
